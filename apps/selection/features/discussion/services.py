...
class DiscrepancyResolutionService:
    ...
    def assign_third_reviewer(self, paper_id: str, reviewer, stage: str) -> dict:
        ...
        """
        from apps.selection.features.screening.models import PaperAssignment
        from apps.selection.features.discussion.models import ConflictResolution
        from apps.selection.models.choices import AssignmentStageChoices, ResolutionMethodChoices
